...
csv_file_out = scr_dir + r'\CSV\1socapteka.csv'

URL = 'http://первая-социальная-аптека.рф/catalog/lekarstvennye-sredstva-37/allergologiya-4/'
HOST = 'http://первая-социальная-аптека.рф'
...
def get_content(link):
    ...
    find_div = soup.find('div', class_='detail_text')
    if find_div:
